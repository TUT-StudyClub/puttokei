...
export type HourglassVariantConfig = {
  asset: number;
  baseWidth: number;
  baseHeight: number;
  viewBoxWidth: number;
...
const HOURGLASS_GRAY_CONFIG: HourglassVariantConfig = {
  asset: require('../../../../assets/images/session/hourglass-gray.svg'),
  baseWidth: 18,
  baseHeight: 31,
  viewBoxWidth: 18,
  viewBoxHeight: 31,
...
const HOURGLASS_BLUE_CONFIG: HourglassVariantConfig = {
  asset: require('../../../../assets/images/session/hourglass-blue.svg'),
  baseWidth: 24,
  baseHeight: 41,
  viewBoxWidth: 24,
  viewBoxHeight: 41,
...
const HOURGLASS_PURPLE_CONFIG: HourglassVariantConfig = {
  ...
  asset: require('../../../../assets/images/session/hourglass-purple.svg'),
...
function getHourglassSandLayerShapes(
  ...
  const lowerHeights = indexed.map(({ layer }) => {
    const normalizedWeight = layer.weight / totalWeight;
    const safeProgress = clampSandProgress(layer.progress);
    return lowerTotalHeight * normalizedWeight * (1 - safeProgress);
  });
